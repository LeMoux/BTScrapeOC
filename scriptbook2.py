...
# Fonction pour rechercher toutes les catégories du site et créer le répertoire csv
...
# Fonction pour rechercher toutes les urls de livres
...
# Fonction pour récuperer les informations produits
...
# Fonction pour récuperer images de livres et les classer par catégories
...
# Fonction de création de fichier CSV
